...
"""
import click#for creating beautiful command line interfaces in a composable way with as little code as necessary
import os## provides a way of using operating system dependent functionality like fileopen or path of file
import pandas as pd# library providing data structures and analysis tools for python
import random#Random variable generators.
import time# handle time-related tasks
import urllib.parse#focus on splitting a URL string into its components, or on combining URL components into a URL string
import urllib.request#module defines functions and classes which help in opening URLs

from bs4 import BeautifulSoup# It sits atop an HTML or XML parser, providing Pythonic idioms for iterating, searching, and modifying the parse tree.
...
SP500_LIST_PATH = os.path.join(DATA_DIR, "SP500.csv")
